document.addEventListener("DOMContentLoaded", function () {
  ...
  document.querySelector(
    "footer p"
  ).innerHTML = `© ${currentYear} Ngô Anh Khoa | <a href="#" id="download-pdf" class="footer-link">Tải CV (PDF)</a> | <a href="#" class="footer-link">Liên hệ</a>`;
  ...
  const createMobileNav = () => {
    if (window.innerWidth < 768 && !document.querySelector(".mobile-nav")) {
      ...
      document
        ...
        .insertBefore(mobileNav, document.querySelector("header"));
